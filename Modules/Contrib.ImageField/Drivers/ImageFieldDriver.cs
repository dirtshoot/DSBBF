...
using Contrib.ImageField.ViewModels;
...
namespace Contrib.ImageField.Drivers {
    ...
    public class ImageFieldDriver : ContentFieldDriver<Fields.ImageField> {
        ...
        protected override DriverResult Display(ContentPart part, Fields.ImageField field, string displayType, dynamic shapeHelper) {
            return ContentShape("Fields_Contrib_Image", GetDifferentiator(field, part), 
                () =>
                    shapeHelper.Fields_Contrib_Image( // this is the actual Shape which will be resolved (Fields/Contrib.Image.cshtml)
